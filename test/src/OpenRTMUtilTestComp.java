...
/*!
 * @class OpenRTMUtilTestComp
 * @brief Standalone component Class
 *
 */
public class OpenRTMUtilTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(OpenRTMUtilTest.component_conf);
      mgr.registerFactory(prop, new OpenRTMUtilTest(), new OpenRTMUtilTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("OpenRTMUtilTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        OpenRTMUtilTestComp init = new OpenRTMUtilTestComp();
